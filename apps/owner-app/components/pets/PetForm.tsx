...
import { Pet, PetFormData, usePetStore } from '@/shared/stores/petStore';
    ...
    Alert.alert('Select Photo', 'Choose photo source', [
      {
        text: 'Camera',
        onPress: async () => {
          const { takePhotoWithCamera } = await import('@/shared/stores/petStore');
      ...
      },
      {
        text: 'Gallery',
        onPress: async () => {
          const { pickImageFromGallery } = await import('@/shared/stores/petStore');
